    ...
    '@graph': [
      ...
      },
      {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 5, name: 'Semak harga pasaran', text: 'Guna Paqar untuk dapat keputusan lengkap untuk satu unit — harga, skrip rundingan, soalan untuk penjual dan checklist deposit. Laporan Pembeli RM29, disemak oleh manusia sebelum dihantar.' },

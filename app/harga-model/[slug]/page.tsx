...
export default async function YearModelPage({ params }: Props) {
  ...
  // inside FAQPage JSON-LD. Those are the RM12 report's evidence — median,
      ...
      <Shell>
        <div className="pt-6 pb-12 max-w-xl mx-auto space-y-6">
          ...
          {/*
            ...
            listing count under that. All three are RM12 evidence. What remains
          ...
          */}
            ...
            {teaser ? (
              <>
                {/*
                  ...
                  minimum and maximum, which are the RM12 report's range and the
          ...
          {/*
            ...
            between them, which is the RM12 report's evidence rederived rather
          ...
          */}
          ...
          {/*
            ...
            computed as max x 1.08, which is the price gap the RM12 report
          ...
          {stats && (
            <>
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-[14px] p-5">
                ...
                <p className="font-body text-[13px] text-[#374151] leading-relaxed">
                  Masukkan harga yang diminta penjual. Paqar bandingkan dengan unit setara yang
                  sedang dijual, kemudian beritahu sama ada harga itu di atas, dalam, atau di bawah
                  paras pasaran semasa — percuma.
                </p>
                <p className="font-body text-[13px] text-[#6B7280] leading-relaxed mt-2">

...
export const metadata: Metadata = {
  ...
  description: 'Harga pasaran kereta terpakai Perodua — Myvi, Axia, Bezza, Alza mengikut tahun. Hantar iklan unit yang anda nak beli sebelum bayar deposit.',
    ...
    <>
      ...
      <Shell>
        <div className="pt-6 pb-12 max-w-xl mx-auto space-y-6">
          ...
          <GuideRelated slug="harga-perodua-terpakai" />
        </div>
      </Shell>
    </>
  )

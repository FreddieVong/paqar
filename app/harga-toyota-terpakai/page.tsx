...
export const metadata: Metadata = {
  title: 'Harga Toyota Terpakai Malaysia 2025 — Semak Harga Pasaran | Paqar',
  description: 'Harga pasaran kereta terpakai Toyota — Vios, Camry, Hilux mengikut tahun. Semak sama ada harga penjual berpatutan sebelum bayar deposit.',
  alternates: { canonical: 'https://paqar.my/harga-toyota-terpakai' },
}

const MODELS = [
  { slug: 'toyota-vios', model: 'Vios', range: 'RM36k – RM80k', tag: 'Sedan Jepun paling tahan lama' },
]

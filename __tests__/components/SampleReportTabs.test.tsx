 ...
 * selected. Before this, a screen reader announced "Laporan Pembeli RM29,
 * button" and "+ Accident/Claim RM100, button" with no indication that one was
...
// Named by tier, not by price: the base report moved RM12 → RM29 and the
// add-on RM88 → RM100, and a test keyed on the number fails for a price change
// rather than for the accessibility property it exists to guard.
const rm12 = () => screen.getByRole('tab', { name: /Laporan Pembeli RM/ })
const rm88 = () => screen.getByRole('tab', { name: /Accident\/Claim RM/ })

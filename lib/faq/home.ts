...
export const HOME_FAQ: readonly FaqEntry[] = [
  {
    ...
    // States the boundary in both directions. A buyer looking at the proof beat
    // sees a locked RM88 history row a few centimetres above this answer, so
    // "RM12 does not include claim or odometer history" has to be said, not
    // implied by omission.
    a: 'Semakan percuma beri keputusan harga — murah, wajar atau mahal — dengan penjelasan dan tahap keyakinan data. Laporan Pembeli (RM12) tambah angka berdasarkan iklan setanding iaitu harga tengah dan julat, anggaran trade-in, maklumat pendaftaran kenderaan, soalan untuk penjual dan skrip rundingan. Laporan RM12 tidak termasuk rekod tuntutan kemalangan atau bacaan odometer — itu semakan berasingan (+RM88).',
  },
  {
